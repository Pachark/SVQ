...
class Quantization(nn.Module):
    ...
    Implementation of `SVQ: Sparse Vector Quantization for Spatiotemporal Forecasting
...
class SVQ(nn.Module):
    def __init__(self,
        ...
        self.proj_regression_weight = MLPProjection(input_dim, codebook_size, middim, codebook_size, nonlinear)
...
class MLPProjection(nn.Module):
    def __init__(self, N, M, k, codebook_size, nonlinear):
